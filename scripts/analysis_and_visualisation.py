...
if __name__=='__main__':
    ...
    2c) Check if the failures are being caused based on the quality of the product. 
    ...
    # For each different possible type of failure try to investigate if there is any correlation between any of the settings the machine was running at. 
    from manufacturing_eda_classes import LoadData, DataFrameInfo, DataTransform, Plotter, Models
    ...
    # Correlation Heatmap threshold = 0.4
    plott = Plotter(failure_data_df)
